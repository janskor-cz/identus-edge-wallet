                        ...
                        {(() => {
                            ...
                            if (isEnterpriseMode) {
                                ...
                                return enterpriseConnections.map((connection, i) => {
                                    ...
                                    const statusBgColor = isConnected ? 'bg-green-100' : 'bg-yellow-100';
                                    const statusTextColor = isConnected ? 'text-green-800' : 'text-yellow-800';
                                    ...
                                    return (
                                        <div key={`ent-connection-${connection.connectionId}`} className={`glass-card p-6 mb-4 ${isConnected ? 'border-l-4 border-green-500' : 'border-l-4 border-yellow-500'} hover:transform hover:scale-105 transition-all duration-300`}>
                                            <div className={`${statusBgColor} ${statusTextColor} rounded-lg p-4 text-center`}>
                                                ...
                                                <div className="flex items-center justify-center space-x-2 mt-2">
                                                    <span className="px-3 py-1 rounded-full text-xs font-semibold bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-200 border border-purple-300 dark:border-purple-700">
                                            ...
                                            {isDetailsShown && (
                                                <div className="mt-6 space-y-4 animate-fadeIn">
                                                    <div className="glass-card p-4">
                                                        <label className="text-sm font-semibold opacity-80 block mb-2">
                                                            Connection ID
                                                        </label>
