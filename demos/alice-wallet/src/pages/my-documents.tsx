...
const getClassificationBadge = (level: string) => {
  switch (level?.toUpperCase()) {
    ...
    default:
      return { color: 'bg-gray-100 text-gray-800 border-gray-300', label: level || 'UNKNOWN' };
  }
};
...
const DocumentCard: React.FC<{
  ...
  return (
    <div className={`border-2 rounded-lg overflow-hidden transition-shadow ${
      document.isExpired
  ...
  const handleDownload = useCallback(async (ephemeralDID: string) => {
    try {
      ...
      if (!secretKey) {
        ...
        const relevantKeys = allKeys.filter(k => k.includes('ephemeral') || k.includes('wallet-alice'));
          ...
          <Box>
                ...
                <div className="flex items-center gap-6">
                  ...
                  {classifiedDocuments.stats && (
                    <div className="border-l border-gray-300 pl-6">
                      <div className="text-sm text-gray-500">By Classification:</div>
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              {expiredCount > 0 && (
                <button
                  ...
                  className="ml-auto px-4 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 flex items-center gap-2"
                >
                  <TrashIcon className="w-4 h-4" />
            ...
            <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-yellow-800">Time-Limited Access</div>
            ...
            <div className="mt-4 p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-purple-800">Section-Level Redaction</div>
