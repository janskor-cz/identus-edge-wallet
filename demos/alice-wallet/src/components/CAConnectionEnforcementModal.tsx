...
export const CAConnectionEnforcementModal: React.FC<CAConnectionEnforcementModalProps> = ({
  ...
  return (
    <>
      ...
      {/* Main Modal */}
      <div
        className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[9998]"
      ...
      >
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-6 py-5 rounded-t-xl">
            <div className="flex items-center space-x-4">
              <div className="w-14 h-14 bg-white/20 rounded-full flex items-center justify-center">
                <span className="text-3xl">🏛️</span>
              </div>
              <div>
                <h2 className="text-2xl font-bold">Connect to Certification Authority</h2>
