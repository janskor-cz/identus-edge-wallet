...
import { InviterIdentity, FIELD_LABELS, DisclosureLevel } from '../types/invitations';
...
interface InvitationPreviewModalProps {
  ...
  // ✅ MODAL FIX: VC selection props for Bob to share credentials with inviter
  availableCredentials?: any[];
  selectedVCForRequest?: any | null;
  onVCSelectionChange?: (vc: any | null) => void;
...
export const InvitationPreviewModal: React.FC<InvitationPreviewModalProps> = ({
  ...
  inviterLabel,
  invitationData,
  // ✅ MODAL FIX: Extract VC selection props
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            {/* ✅ MODAL FIX: VC Selection UI for Bob to share credentials with inviter */}
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4 bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700">
                  <div className="flex items-center space-x-3 mb-4">
                    <input
                      type="checkbox"
                      id="attachVCToRequestModal"
                      checked={selectedVCForRequest !== null}
                      onChange={(e) => {
                        if (onVCSelectionChange) {
                          if (!e.target.checked) {
                            onVCSelectionChange(null);
                          } else if (availableCredentials.length > 0) {
                            onVCSelectionChange(availableCredentials[0]);
                          }
                        }
                      }}
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="attachVCToRequestModal" className="text-sm font-medium text-gray-900 dark:text-white">
                      🔒 Share your credential with inviter
                    </label>
                  </div>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            if (onVCSelectionChange) {
                              ...
                              onVCSelectionChange(availableCredentials[index] || null);
                            }
                          }}
                        >
