...
import { SecurityClearanceRequestor } from "@/components/SecurityClearanceRequestor";
import { CAHyperlinkGenerator } from "@/components/CAHyperlinkGenerator";
  ...
  return (
    <>
      <div className="mx-10 mt-5 mb-30">
        ...
        <Mnemonics />
        <BackupRestore />
        <CAHyperlinkGenerator />
        <SecurityClearanceKeyManager />
        <SecurityClearanceRequestor />
